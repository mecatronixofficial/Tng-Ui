...
export const metadata: Metadata = {
  ...
  "Thangavel Textile contact",
  "Thangavel Textile Erode contact",
  "textile supplier contact Erode",
  "textile manufacturer contact Erode",
  "textile wholesaler contact Erode",
  "textile supplier Erode Tamil Nadu",
  "wholesale textile enquiry",
  "wholesale cloth enquiry",
  "textile wholesale enquiry Erode",
  "cotton textile wholesale enquiry",
  "cotton textile supplier contact",
  "textile manufacturer enquiry Erode",
  "textile wholesale supplier Erode",
  "contact textile manufacturer Tamil Nadu"
],
