...
export const metadata: Metadata = {
  ...
  "textile products Erode",
  "textile products wholesale Erode",
  "textile wholesale supplier Erode",
  "cotton textile products Erode",
  "petticoat wholesale Erode",
  "cotton petticoat wholesale",
  "lungi wholesale Erode",
  "cotton lungi wholesale",
  "towel wholesale Erode",
  "cotton towel wholesale",
  "bed sheet wholesale Erode",
  "cotton bed sheet wholesale",
  "dhoti wholesale Erode",
  "cotton dhoti wholesale",
  "textile categories Erode",
  "wholesale cloth supplier Erode",
  "textile manufacturer and wholesaler Erode"
],
